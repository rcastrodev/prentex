...
@includeIf('administrator.subcategory.modals.create')
@includeIf('administrator.subcategory.modals.update')
@stop
@section('css')
    <meta name="_token" content="{{csrf_token()}}">
    <meta name="url" content="{{route('subcategory.content')}}">
    <meta name="content_find" content="{{route('subcategory.content')}}">
