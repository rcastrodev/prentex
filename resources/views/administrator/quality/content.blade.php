        ...
        <form action="{{ route('quality.content.updateInfo') }}" method="post" class="row mt-5 mb-5" data-sync="no" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    @endif
                    <small>la imagen debe ser al menos 600x313px</small>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    @if (Storage::disk('public')->exists($section1->image2))
                        <img src="{{Storage::disk('public')->url($section1->image2)}}" class="img-fluid d-block mb-3">
                    @endif
                    <small>la imagen debe ser al menos 1219x383px</small><br>
