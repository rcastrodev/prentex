    ...
    <form action="{{ route('data.content.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="email" value="{{$data->email}}" class="form-control" placeholder="Correo que recibira los mail de contacto">
            </div>
            <div class="form-group">
                <input type="text" name="phone3" value="{{$data->phone3}}" class="form-control" placeholder="Número de whatsapp">
            </div>
            <div class="form-group">
                <input type="text" name="facebook" value="{{$data->facebook}}" class="form-control" placeholder="Link|usuario">
            </div>
            <div class="form-group">
                <input type="text" name="instagram" value="{{$data->instagram}}" class="form-control" placeholder="Link|usuario">
            </div>
            <div class="form-group">
